...
// import UserConnect from '../../../../specificComponents/ReduxComponents/componentUser';
...
const UserHeader: React.FC<UserHeaderProps> = () => {
  ...
  return (
    <div className='user-header'>
        <>
      {/* {<UserConnect/>?  <div className='emailIconUser'><UserConnect/><img alt='usuario.png' src='usuario.png'></img></div>:( */}
        <>
